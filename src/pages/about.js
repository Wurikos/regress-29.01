...
import { Theme, Link, Text, Button, Icon, Box, Image } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		...
		<RawHtml>
			<script async={true} place={"endOfHead"} rawKey={"6013c3c775c10bc40a2aae0a"}>
				{"console.log (\"ТЕСТ\")"}
			</script>
			<style place={"endOfHead"} rawKey={"6013c40bd358218033b3287f"}>
				{"body {\nbackground-color:red}"}
			</style>
			<script async={true} place={"endOfHead"} rawKey={"6013c3e6e030c0e2a9d89629"}>
				{"console.log(\"testpageABOUT\")"}
			</script>
		</RawHtml>
	</Theme>;
});